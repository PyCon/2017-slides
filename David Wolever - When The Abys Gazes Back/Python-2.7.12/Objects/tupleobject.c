...
tuplecontains(PyTupleObject *a, PyObject *el)
{
    ...
    /**
     ** It's always fun to read through the Python code and notice when the
     ** underlying code is actually incredibly simple. This is a CS101 for
     ** loop!
     **/
    for (i = 0, cmp = 0 ; cmp == 0 && i < Py_SIZE(a); ++i) {
        /**
         ** This looks like the same PyObject_RichCompare as before... but
         ** there's an important difference! This is PyObject_RichCompareBool!
         **                                                              ^^^^
         **/
